    ...
    <div class="col-xs-12">
       ...
       <div class="col-md-offset-2 col-md-8">
           ...
           <div  class="panel panel-primary">
				...
				<div class="form-group">
							<label class="control-label col-md-4" for="discription">Description</label>
							<div class="col-md-8">
								
							<sf:textarea rows="4" id="description" path="description" placeholder="Enter your description here!"></sf:textarea>
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<sf:input id="unitPrice" path="unitPrice"
									placeholder="Enter Unit Price &#8377" class="form-control"/>
               ...
               <sf:form   id="categoryForm" modelAttribute="category" action="${contextRoot}/manage/category" method="POST" class="form-horizontal">
                 ...
                 <div class="form-group">
                    <label for="description"  class="control-label col-md-4">Category Description</label>
                       <div class="col-md-8">
                         <sf:textarea path="description" cols="" rows="5" type="text" class="form-control" id="category_description"/>
                       </div>
